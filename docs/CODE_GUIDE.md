...
## 마무리
이번 프로젝트를 하며, 프론트엔드 개발자는 어떠한 역할을 담당하고 어떤 고민을 하게 되는 지 알고 싶었습니다.
지금 제가 맞는 고민을 하는 지 프론트엔드 개발자로써 방향성을 잘 잡고 나아가고 있는 지는 확실하지 않지만
제 나름대로 무언가를 적용할 때 항상 이유를 생각하게 되고 발전할 수 있는 코드를 위해 고민을 하는 경험을 하게 되었습니다.

이 경험을 토대로 STOVE에서도 발전하기 위해 끊임 없이 노력을 할 예정이며
어떠한 문제를 마주해도 생각을 통해 해결할 수 있는 문제 해결 능력을 가진 개발자가 되도록 하겠습니다.

긴 글 봐주셔서 감사드립니다 :)

# 이상 성종현 인턴이었습니다. 고생하셨습니다!👏👏👏
